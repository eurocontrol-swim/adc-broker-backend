...
def base_exception_handler(exc, context):
    ...
    handlers = {
        ...
        'Http400': _handle_generic_error,
        'OperationalError': _handle_internal_error
...
def _handle_internal_error(exc, context, response):
    raise Exception('An error has occurred, please contact an administrator')
